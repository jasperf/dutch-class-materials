# Handout S5 — Weet u de weg?

**Datum:** Donderdag 30 april 2026
**Unit:** 05 — *weet u de weg?* *(do you know the way?)*
**Boek:** blz. 51–63
**Duur:** 2 uur
...
### **1. Geboden (Imperatives)**
De gebiedende wijs = **werkwoordstam** alleen:
...
| **Tijd** | **Activiteit** |
|----------|----------------|
| 0:00–0:10 | Warm-up: modale werkwoorden + meervoudsvormen controleren |
| 0:10–0:35 | Dialoog Unit 05: boek open, lezen + bespreken |
| 0:35–1:05 | Vocabulaire richtingen + voorzetsels van plaats |
| 1:05–1:35 | Geboden: uitleg + oefeningen |
| 1:35–1:50 | Rolspel: de weg vragen in de straat |
| 1:50–2:00 | Huiswerk toelichten |

---

## **Huiswerk**
📝 **Schrijfopdracht:** Teken een **eenvoudige straatkaart** en schrijf een routebeschrijving van A naar B (in het Nederlands, 8+ stappen)