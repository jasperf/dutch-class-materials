...
- [ ] Student knows the most common Dutch prepositions and their fixed combinations
- [ ] Student can use verb + preposition combinations (phrasal equivalents)

### Agenda
| Time | Activity |
|------|----------|
| 0:00–0:10 | Homework review: phone dialogue + zouden sentences |
| 0:10–0:40 | Conditional sentences: Als… zou(den)… |
| 0:40–1:10 | Prepositions: fixed verb + preposition combinations |
| 1:10–1:40 | Exercise: fill in correct preposition; then free sentences |
| 1:40–1:55 | Conversation: hypothetical questions (Wat zou jij doen als…?) |
| 1:55–2:00 | Homework |
...
### Objectives
- [ ] Student can use subordinate clauses (dat, omdat, als, of, wanneer) correctly
- [ ] Student understands word order in subordinate clauses (verb to end)
- [ ] Student can talk about skills, career, and study

### Agenda
| Time | Activity |
|------|----------|
| 0:00–0:10 | Warm-up: zouden sentences + conditional quick drill |
| 0:10–0:35 | Unit 13 dialogue: open book, read + discuss |
| 0:35–1:05 | Subordinate clause word order: verb always to the END |
| 1:05–1:35 | Common subordinating conjunctions + practice combining sentences |
| 1:35–1:50 | Career/skills conversation: talk about ambitions |
| 1:50–2:00 | Homework |
