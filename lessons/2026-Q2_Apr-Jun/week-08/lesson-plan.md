...
**S18 (Mon 8 Jun):** Unit 13 practice + Unit 14 — *ik begrijp precies hoe je je voelt* — book pp 174–208
**S19 (Thu 11 Jun):** Units 15–16 survey + revision — book pp 209–243
**S20 (Sun 14 Jun):** Final session — conversation test + feedback
**Cumulative hours:** 40 ← COURSE COMPLETE

---

## S18 — Unit 13 practice + Unit 14: ik begrijp precies hoe je je voelt (pp 174–208)

**Unit 13 themes:** Career advice and training · skills · interjections
**Unit 14 themes:** Talking about physical and emotional well-being

### Objectives
- [ ] Student can talk about skills, career and study using subordinate clauses
- [ ] Student can describe physical ailments and emotions in Dutch
- [ ] Student can use reflexive verbs (*zich voelen, zich vergissen*, etc.) and express sympathy

### Agenda
| Time | Activity |
|------|----------|
| 0:00–0:10 | Homework review: subordinate clause + preposition sentences |
| 0:10–0:35 | Unit 13: career/skills vocabulary + ambitions conversation |
| 0:35–0:55 | Unit 14 dialogue: open book, read + discuss |
| 0:55–1:25 | Reflexive verbs: *zich* + reflexive pronoun |
| 1:25–1:50 | Health + emotions vocabulary + expressing sympathy; role play |
| 1:50–2:00 | Homework for the survey session |

### Vocabulary — Career & skills (Unit 13)
| Dutch | English |
|-------|---------|
...
### Vocabulary — Health & emotions (Unit 14)
| Dutch | English |
|-------|---------|
