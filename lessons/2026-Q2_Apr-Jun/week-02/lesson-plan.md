...
## S4 — Unit 04: de boodschappen (pp 37–50)

**Unit 04 themes:** Buying food and groceries · asking for things in shops/markets · saying what you want · saying how much you want · using money

### Objectives
- [ ] Student can handle a basic grocery/market shopping interaction
- [ ] Student can use modal verbs (willen, kunnen, mogen, moeten) correctly
- [ ] Student can form plural nouns

### Agenda
| Time | Activity |
|------|----------|
| 0:00–0:10 | Warm-up: de/het quiz on 20 random nouns |
| 0:10–0:35 | Unit 04 dialogue: open book, read + discuss |
| 0:35–1:05 | Plurals: -en, -s, -'s, vowel-change types |
| 1:05–1:35 | Modal verbs: willen/kunnen/mogen/moeten + infinitive at end |
| 1:35–1:50 | Role play: at the market / supermarket |
| 1:50–2:00 | Homework |

### Vocabulary — Food & shopping
| Dutch | English |
|-------|---------|
| boodschappen doen | to do the shopping |
| Ik wil graag… | I'd like… |
| Heeft u…? / Hebben jullie…? | Do you have…? |
| een ons / een pond / een kilo | 100g / 500g / 1kg |
| een flesje / een pakje / een blikje | a bottle / a packet / a tin |
| Hoeveel kost dat? | How much does that cost? |
| Dat kost… euro | That costs… euros |
| betalen | to pay |
...
| Rule | Example |
|------|---------|
| + -en (most nouns) | de man → de mannen |
| + -s (ends in -el, -em, -en, -er, -aar) | de tafel → de tafels |
| + -'s (ends in a, o, u, i, y) | de foto → de foto's |
| Long vowel shortens + -en | de stad → de steden; de weg → de wegen |

### Grammar — Modal verbs (+ infinitive at end)
| Dutch | English | Example |
|-------|---------|---------|
| willen | to want | Ik wil graag een kilo appels **kopen**. |
| kunnen | can | Kunt u dat **herhalen**? |
| mogen | may | Mag ik dit **proberen**? |
| moeten | must / have to | Ik moet vandaag **boodschappen doen**. |
